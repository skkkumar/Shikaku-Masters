...
public class SizePerformanceComparator {
	...
	public static void main(String[] args) {
		...
		final LineChartDemo demo = new LineChartDemo("Nodes expanded for varying complexities",
				dataPoints1[0], dataPoints2[0], dataPoints1[1], dataPoints2[1],
				dataPoints1[2], dataPoints2[2],
				"sample no. for varying complexity", "no. of nodes expanded");
		demo.pack();
